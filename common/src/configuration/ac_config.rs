...
pub struct ACConfig {
    ...
    pub sc2_cont_1_host: String,
    pub sc2_cont_1_port: Port,
    pub sc2_cont_2_host: String,
    pub sc2_cont_2_port: Port,
...
mod tests {
    ...
    fn ac_config() -> ACConfig {
        ACConfig {
            ...
            sc2_cont_1_host: "123".to_string(),
            sc2_cont_1_port: 0,
            sc2_cont_2_host: "123".to_string(),
            sc2_cont_2_port: 0,
            secure_mode: false,
            strikes: 0,
